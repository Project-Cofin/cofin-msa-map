...
class NerTest:
    ...
    # 시퀀스를 NER 태그로 변환
    def sequences_to_tag(self, sequences, index_to_ner):
        result = []
    ...
    def execute(self):
        ...
        pred_tags = self.sequences_to_tag(y_predicted, index_to_ner)  # 예측된 NER
        test_tags = self.sequences_to_tag(y_test, index_to_ner)  # 실제 NER
